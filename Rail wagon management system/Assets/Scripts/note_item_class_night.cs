...
public class note_item_class_night : MonoBehaviour
{
    ...
    public void Detete_note()
    {
        ...
        Command.Instance.perf_code_night.Delete_note(this.gameObject.name);
    ...
    public void Update_time()
    {
        ...
        Command.Instance.perf_code_night.modify_home(planned_activities, active_loco, wagon_plan, achieved_activities, loco, wagon,
